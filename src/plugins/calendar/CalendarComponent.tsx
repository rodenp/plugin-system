...
interface CalendarProps extends PluginProps {
  ...
  onViewChange?: (view: 'month' | 'week' | 'day') => Promise<void>;
  onLoadEvents?: (startDate: Date, endDate: Date) => Promise<void>;
}
...
export const CalendarComponent: React.FC<CalendarProps> = ({ 
  ...
  const [selectedDate, setSelectedDate] = React.useState<Date | null>(props.selectedDate || null);
        ...
        React.createElement('div', {
          ...
          calendarDays.map((day: any, index: number) => {
            ...
            return React.createElement('div', {
              ...
              day.hasEvent && React.createElement('div', {
                style: {
