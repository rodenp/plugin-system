...
const MembersComponent = ({ currentUser, communityId, community, userRole, theme, ...props }) => {
    ...
    }, `Members ${community?.stats?.memberCount || 0}`), React.createElement('button', {
        style: {
            padding: `${appliedTheme.spacing.sm} ${appliedTheme.spacing.md}`,
    ...
    }, 'Admins 8'), React.createElement('button', {
        style: {
            padding: `${appliedTheme.spacing.sm} ${appliedTheme.spacing.md}`,
            backgroundColor: appliedTheme.colors.surfaceAlt,
            color: appliedTheme.colors.textSecondary,
    ...
    }, `Online ${community?.stats?.memberCount ? Math.floor(community.stats.memberCount * 0.1) : 0}`)), React.createElement('button', {
        style: {
            color: 'white',
            padding: `${appliedTheme.spacing.sm} ${appliedTheme.spacing.md}`,
            borderRadius: appliedTheme.borders.borderRadius,
    ...
    }, member.name.charAt(0))), member.online && React.createElement('div', {
        style: {
            position: 'absolute',
            bottom: '-4px',
            right: '-4px',
    ...
    }, member.username)), React.createElement('button', {
        style: {
            color: 'white',
            padding: `${appliedTheme.spacing.sm} ${appliedTheme.spacing.md}`,
            borderRadius: appliedTheme.borders.borderRadius,
    ...
    }, member.bio), React.createElement('div', {
        style: {
            display: 'flex',
            alignItems: 'center',
            gap: appliedTheme.spacing.md,
    ...
    }), 'Online now'), React.createElement('span', {}, `📍 ${member.location}`), React.createElement('span', {}, `📅 Joined ${member.joined}`)))))), 
    // Error display
