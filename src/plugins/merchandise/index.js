...
const MerchComponent = ({ currentUser, communityId, community, userRole, theme, ...props }) => {
    ...
    }, `Cart (${props.cart.length})`), context.isOwner && React.createElement('button', {
        style: {
            color: 'white',
            padding: `${appliedTheme.spacing.sm} ${appliedTheme.spacing.md}`,
            borderRadius: appliedTheme.borders.borderRadius,
    ...
    React.createElement('div', {
    ...
    }, products.map((product, i) => React.createElement('div', {
        key: product.id || i,
        style: {
        ...
        onMouseEnter: product.soldOut ? undefined : (e) => e.target.style.opacity = '0.9',
        onMouseLeave: product.soldOut ? undefined : (e) => e.target.style.opacity = '1'
    ...
    }, 'Start selling merchandise to your community'), context.isOwner && React.createElement('button', {
        style: {
            color: 'white',
...
export const merchandisePlugin = {
    id: 'merchandise',
    name: 'Merchandise',
