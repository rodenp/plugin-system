...
const LeaderboardComponent = ({ currentUser, communityId, community, userRole, theme, ...props }) => {
    ...
    React.createElement('div', {
        ...
        : React.createElement('span', {}, featuredMember.name?.charAt(0) || '👤')), React.createElement('div', {
        style: {
            position: 'absolute',
            bottom: '5px',
            right: '5px',
    ...
    }, featuredMember.level || '1')), React.createElement('div', {
        style: {
            textAlign: 'center'
        }
    ...
    }, featuredMember.name), React.createElement('p', {
        style: {
            fontSize: appliedTheme.font.sizeMd,
            color: appliedTheme.colors.textSecondary,
            margin: 0,
    ...
    }, `Level ${featuredMember.level || 1}`), React.createElement('p', {
        style: {
            fontSize: appliedTheme.font.sizeMd,
            color: appliedTheme.colors.textSecondary,
            margin: 0
    ...
    }, levels.map((level, index) => React.createElement('div', {
        key: level.level,
        style: {
            display: 'flex',
            alignItems: 'center',
    ...
    }, `Level ${level.level}`), level.requirement && React.createElement('p', {
        style: {
    ...
    }, 'Leaderboard (7-day)'), React.createElement('div', {
        style: {
            display: 'flex',
            flexDirection: 'column',
            gap: appliedTheme.spacing.sm
        }
    }, (leaderboards.sevenDay || []).map((member, index) => React.createElement('div', {
        key: member.id,
        style: {
            display: 'flex',
            alignItems: 'center',
    ...
    }, renderRank(index + 1), React.createElement('div', {
        style: {
            width: '32px',
            height: '32px',
            borderRadius: '50%',
    ...
    }, 'Leaderboard (30-day)'), React.createElement('div', {
        style: {
            display: 'flex',
            flexDirection: 'column',
            gap: appliedTheme.spacing.sm
        }
    }, (leaderboards.thirtyDay || []).map((member, index) => React.createElement('div', {
        key: member.id,
        style: {
            display: 'flex',
            alignItems: 'center',
    ...
    }, 'Leaderboard (all-time)'), React.createElement('div', {
        style: {
            display: 'flex',
            flexDirection: 'column',
            gap: appliedTheme.spacing.sm
        }
    }, (leaderboards.allTime || []).map((member, index) => React.createElement('div', {
        key: member.id,
        style: {
            display: 'flex',
            alignItems: 'center',
    ...
    currentUserRank.allTime && React.createElement('div', {
    ...
    }, 'Your rank'), React.createElement('div', {
        style: {
            display: 'flex',
            alignItems: 'center',
            gap: appliedTheme.spacing.sm,
        ...
        }, currentUser?.profile?.displayName?.charAt(0) || '👤')), React.createElement('div', {
        style: {
            flex: 1,
            minWidth: 0
        }
    ...
    }, currentUser?.profile?.displayName || 'Peter Roden')), React.createElement('div', {
        style: {
            fontSize: appliedTheme.font.sizeSm,
            fontWeight: 600,
            color: appliedTheme.colors.textPrimary
