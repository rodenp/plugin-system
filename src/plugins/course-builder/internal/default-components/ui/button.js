...
const Button = React.forwardRef(({ variant = 'default', size = 'default', theme = defaultTheme, style, onMouseEnter, onMouseLeave, disabled, ...props }, ref) => {
    ...
    return (_jsx("button", { ref: ref, style: {
            ...
            ...getVariantStyles(),
            ...style,
        }, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, disabled: disabled, ...props }));
});
